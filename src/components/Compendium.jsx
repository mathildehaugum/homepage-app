    ...
    <div>
      ...
      >
        ...
        <p className="compendium-desc">
          ...
          algoritmer innenfor ordning, søking og sortering av datamengder. Dette
          var et utfordrende og svært lærerikt fag, og jeg likte at det var
          fokus på forståelse i stedet for pugging.
        </p>
      ...
      <div className="compendium-div" style={{ backgroundColor: "#f76160" }}>
        ...
        <p className="compendium-desc">
          ...
          lærte om sikkerhetens rolle i SDLC, og vi fikk i oppgave å bruke OWASP
          testguide og Risk Management Framework for å finne utplasserte
          sårbarheter ved en gitt nettside.
        </p>
      ...
      <div className="compendium-div" style={{ backgroundColor: "#31355b" }}>
        ...
        <p className="compendium-desc">
          ...
          kunstig intelligens, og det styrket min motivasjon for å lære mer om
          dette området.
        </p>
      ...
      <div className="compendium-div" style={{ backgroundColor: "#1E453E" }}>
        ...
        <p className="compendium-desc">
          I dette emnet lærte vi om ulike typer informasjonssystemer, hvordan
          man kan identifisere organisasjoners behov og hvordan man kan fremme
          suksessfull implementering av endringer. Dette var et spennende emne,
          for tidligere har vi lært hvordan man kan lage systemene, men nå fikk
          vi også lære hvordan man kan legge til rette for at systemet faktisk
          blir brukt av kunden.
        </p>
      ...
      <div className="compendium-div" style={{ backgroundColor: "#E29470" }}>
        ...
        <p className="compendium-desc">
          Etter å ha lært en del om generell programmering var det på tide å få
          mer kunnskap i hvordan man skaper gode brukeroppleveler. I
          øvingsopplegget fikk vi i oppgave å lage en lavnivå prototype av en
          mobil applikasjon og gjennomføre brukertesting. Jeg synes det var
          interessant å lære om denne delen av programvareutvikling og fint å få
          et større utløp for min kreativitet.
        </p>
      ...
      <div className="compendium-div" style={{ backgroundColor: "#4d2c68" }}>
        ...
        <p className="compendium-desc">
          ...
          effektivt utnytte systemressursene. I tidligere emner har vi ofte hørt
          om parallell prosessering og fordeler ved dette, så det var gøyalt å
          endelig lære mer om hvordan det kan implementeres.
        </p>
